...
//        }
  ...
  @IBAction func femaleBtnTapped(_ sender: Any) {
    ...
    maleBtn.clipsToBounds = false
    
    femaleBtn.layer.borderColor = UIColor(displayP3Red: 252.0/255.0, green: 135.0/255.0, blue: 135.0/255.0, alpha: 0.8).cgColor
    femaleBtn.layer.cornerRadius = 2.0
    femaleBtn.layer.borderWidth = 1.0

    femaleBtn.clipsToBounds = false
    
    femaleBtn.layer.shadowColor = UIColor(hex: "FFA7A7").cgColor
    femaleBtn.layer.shadowRadius = 4.0
    femaleBtn.layer.shadowOpacity = 0.5
    femaleBtn.layer.shadowOffset.height = 3.0
  ...
  @IBAction func maleBtnTapped(_ sender: Any) {
    ...
    maleBtn.layer.shadowColor = UIColor(hex: "FFA7A7").cgColor
    maleBtn.layer.shadowRadius = 4.0
    maleBtn.layer.shadowOpacity = 0.6
    maleBtn.layer.shadowOffset.height = 4.0
