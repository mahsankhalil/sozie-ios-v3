...
extension DoubleTextFieldCell: CellConfigurable {
    func setup(_ viewModel: RowViewModel) {
        if let doubleTextFieldCellViewModel = viewModel as? DoubleTextFieldCellViewModeling {
            ...
            setupTextFieldsWith(doubleTextFieldCellViewModel: doubleTextFieldCellViewModel)
    ...
    func setupTextFieldsWith(doubleTextFieldCellViewModel: DoubleTextFieldCellViewModeling) {
